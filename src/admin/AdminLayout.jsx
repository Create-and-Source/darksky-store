...
const ROLE_ALLOWED_ROUTES = {
  admin: null, // all
  shop_manager: ['', '/orders', '/inventory', '/receive', '/events', '/content', '/emails', '/design-studio'],
...
const ROLE_NAV = {
  admin: null, // all
  shop_manager: ['Dashboard', 'Orders', 'Inventory', 'Receive', 'Events', 'Content', 'Email', 'Design Studio'],
